...
**Note:** Quick mode INCLUDES automated code review by agent-rapid-planner (Phase 3). Standard mode does NOT have this.
...
| Mode | Phases | Gates | Docs |
|------|--------|-------|------|
| **Quick** | 3 | 1 | 1 file |
| Standard | 6 | 4 | 4 files |
