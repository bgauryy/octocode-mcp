...
import { computeDependencyCycles, computeDependencyCriticalPaths, buildIssueCatalog, ARCHITECTURE_CATEGORIES, CODE_QUALITY_CATEGORIES, DEAD_CODE_CATEGORIES, SECURITY_CATEGORIES, TEST_QUALITY_CATEGORIES, writeMultiFileReport, severityBreakdown, categoryBreakdown, generateSummaryMd, diverseTopRecommendations, diversifyFindings, computeHealthScore, collectTagCloud, } from './index.js';
function emptyState() {
    return {
        files: new Set(),
        outgoing: new Map(),
...
describe('diversifyFindings', () => {
    const makeDraft = (severity, category, idx) => ({
        severity: severity,
        category,
