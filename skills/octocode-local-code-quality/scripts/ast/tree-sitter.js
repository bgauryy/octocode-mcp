...
import { buildTreeSitterTree, hashString, increment, makeTreeSitterFingerprint, } from '../common/utils.js';
import { TS_TREE_SITTER_CONTROL_TYPES, TS_TREE_SITTER_FUNCTION_TYPES, } from '../types/index.js';
...
export async function resolveTreeSitter() {
    ...
    try {
        ...
        const tsLang = typescriptMod.typescript ||
            typescriptMod.default?.typescript;
        const tsxLang = typescriptMod.tsx ||
            typescriptMod.default?.tsx;
