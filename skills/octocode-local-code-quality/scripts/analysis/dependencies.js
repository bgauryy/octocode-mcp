...
import { addToMapSet, isRelativeImport, isTestFile, normalizeDependencyValue, resolveImportTarget, toRepoPath, } from '../common/utils.js';
            ...
            if (node.exportClause && ts.isNamedExports(node.exportClause)) {
                for (const element of node.exportClause.elements) {
                    reExports.push({
                        ...
                        lineEnd: sourceFile.getLineAndCharacterOfPosition(element.getEnd()).line +
                            1,
                    });
                }
            }
                ...
                reExports.push({
                    ...
                    lineStart: sourceFile.getLineAndCharacterOfPosition(node.getStart(sourceFile))
                        .line + 1,
