...
import { detectSemanticDeadExports, detectOverAbstraction, detectConcreteDependency, detectCircularTypeDependency, detectUnusedParameters, detectTypeHierarchyDepth, detectDeepOverrideChain, detectInterfaceCompliance, detectUnusedImports, detectOrphanImplementation, detectShotgunSurgery, detectMoveToCaller, detectLeakyAbstraction, detectNarrowableType, runSemanticDetectors, } from './semantic-detectors.js';
...
function makeFileEntry(file, overrides = {}) {
    return {
        package: 'test',
        file,
...
function makeProfile(file, overrides = {}) {
    return {
        file,
...
describe('collectAllAbsoluteFiles', () => {
    it('merges files from summaries and dependency state', () => {
        ...
        const entries = [makeFileEntry('a.ts'), makeFileEntry('b.ts')];
        const state = {
