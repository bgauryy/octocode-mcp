...
import { canonicalScriptKind, hashString, normalizeNodeKind, makeFingerprint, getLineAndCharacter, isTestFile, toRepoPath, normalizeDependencyValue, addToMapSet, isRelativeImport, increment, } from './utils.js';
