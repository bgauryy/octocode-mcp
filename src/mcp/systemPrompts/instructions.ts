...
export const PROMPT_SYSTEM_PROMPT = `Research Intelligence Engine - Comprehensive discovery and analysis across GitHub and NPM ecosystems.

## CRITICAL: API STATUS VERIFICATION FIRST
