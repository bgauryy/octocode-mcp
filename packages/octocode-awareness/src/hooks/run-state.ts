...
import { agentId, artifact, autoClaimRationale, fallbackVerificationPlan, firstString, hookSessionCorrelation, objectOrEmpty, payloadInput, resolveHookPath, sessionId } from './payload.js';
