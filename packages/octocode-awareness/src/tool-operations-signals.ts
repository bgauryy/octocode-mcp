...
import type { AgentSignalResult, NotificationKind } from './types/notifications-agents.js';
import type { FileLockReleaseStatus, FileLockResult } from './types/locks-reflection.js';
...
case 'file_lock': {
      ...
      const result = fileLock(db, {
        ...
        status: request['status'] as FileLockReleaseStatus | undefined,
        reasoning: request['reasoning'] as string | undefined,
        testPlan: request['test_plan'] as string | undefined,
      }) as FileLockResult;
