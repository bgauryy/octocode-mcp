/**
 * Synchronous content minification utilities for token optimization
 *
 * This is a lightweight, synchronous alternative to the async minifyContent.
 * It uses simple regex-based minification without external dependencies.
